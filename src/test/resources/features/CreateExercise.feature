Feature:
  ...
  Scenario: As a valid User I can upload my exercise track under my profile
    Given the user "4b05c31e-ceb7-4c9a-b5b9-703e74fbdf1e"
  ...
  Scenario: As a non Registered User I can't upload my exercise track
    Given the invalid user "b2054378-52c6-4832-b46d-6af185783cc8"
    And the exercise track "9fb3f69b-e3ee-4586-8b83-5ff4feec0e27"
